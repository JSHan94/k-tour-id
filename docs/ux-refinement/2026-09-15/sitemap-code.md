...
최초 독립 기준: `b9cdc42` · 브랜치 `ux/flow-refinement-20260915` · 작성일 2026-09-15. 현행 구조는 2026-09-16 `b7bdba0` 기준 `feat/ktour-public-guide-20260916`의 D04 공개 읽기/선택적 저장 v2까지 반영한다. 앱 source `9980472`의 환경별 한정 runtime·배포 검수는 [D04 릴리스](../../KTOUR_PUBLIC_GUIDE_RELEASE_2026-09-16.md)를 따른다.
