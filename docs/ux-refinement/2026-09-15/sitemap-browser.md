...
| CODE-11 | Only manifest-approved exact Onion photography added in this wave. Missing images and image failure remain distinct; imagery does not add merchant capabilities. |
