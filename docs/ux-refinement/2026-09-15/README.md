...
**후속 승인 D04:** [가이드 무료 읽기·선택적 패스 저장](../../KTOUR_PUBLIC_GUIDE_RELEASE_2026-09-16.md). 앱 source `9980472`의 새 구현·독립 검수·운영 배포이며 아래 과거 결과와 구분한다. 현재 sitemap은 공개 reader와 저장 작업을 나눈 80개 의미 노드/279개 전이 행이다.
