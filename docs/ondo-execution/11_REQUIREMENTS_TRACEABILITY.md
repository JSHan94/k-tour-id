...
상태: `SPEC READY · CODE NOT STARTED`
최종 갱신: `2026-08-19`
...
문서 기준 현재 미판정 REQ: `0`
코드 기준 현재 구현 판정: `NOT STARTED`
QA 기준 현재 증거: `NOT STARTED`
...
- [x] `SPEC READY`에서 Code/Commit=`Not started`, QA=`Not run`, As-built=`Not evaluated`인 것은 정상임을 기록

이 gate를 통과한 뒤 [Run Status](./12_RUN_STATUS.md)의 현재 Gate를 `SPEC READY`로 변경한다.
