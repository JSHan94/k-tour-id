...
- 혜택은 금전/실물 제공 의무 없는 ONDO 체험이다. 실제 방문, 10회 방문 badge, 19+, 금융 KYC, KRW 잔액을 올리지 않는다.

## 3. 구현 작업

### HK-06 · Move 권한 및 실제 결과

- package 1개, 캠페인 1개, 비금전 action 1종. ONDO의 검증된 발급 근거와 사용자 승인을 모두 요구한다. 임의 사용자가 유효 권한을 생성하는 public mint는 불가다.
