...
|---|---|---|---|---|---|---|---|
| `FL-001` | `B-E2E-FL-001-ENTRY` ACTUAL | `B-E2E-FL-001-DECISION` ACTUAL | `B-E2E-FL-001-CANCEL` ACTUAL | `B-E2E-FL-001-ERROR` `GAP` — tile 요청 실패에도 MapLibre가 ready가 되어 fallback 미도달 | `B-E2E-FL-001-RETRY` `GAP` — map error에 묶인 retry도 미도달 | `B-E2E-FL-001-TERMINAL` ACTUAL | `B-E2E-FL-001-RETURN` ACTUAL |
| `FL-002` | `B-E2E-FL-002-ENTRY` ACTUAL | `B-E2E-FL-002-DECISION` ACTUAL | `B-E2E-FL-002-CANCEL` ACTUAL | `B-E2E-FL-002-ERROR` ACTUAL | `B-E2E-FL-002-RETRY` ACTUAL | `B-E2E-FL-002-TERMINAL` ACTUAL | `B-E2E-FL-002-RETURN` `GAP` — locked venue/passport-provider context가 없고 일반 After19로만 복귀 |
...
| `FL-011` | `B-E2E-FL-011-ENTRY` ACTUAL | `B-E2E-FL-011-DECISION` ACTUAL | `B-E2E-FL-011-CANCEL` ACTUAL | `B-E2E-FL-011-ERROR` `GAP` — local save failure injection 없음 | `B-E2E-FL-011-RETRY` `GAP` — save failure retry 없음 | `B-E2E-FL-011-TERMINAL` ACTUAL | `B-E2E-FL-011-RETURN` ACTUAL |
...
현재 판정: `115 ACTUAL · 5 GAP · 6 N/A`. `GAP` 5개는 unresolved actionable이라 clean round를 막는다.
