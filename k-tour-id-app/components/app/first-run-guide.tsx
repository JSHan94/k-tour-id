...
const STEPS = [
  {
    ...
    titleKo: "여행할수록 채워지는\n나만의 대한민국 지도예요.",
    titleEn: "A map of Korea that fills\nas you travel.",
    bodyKo: "전국 지도에서 지역을 고르고 실제 지도에서 장소와 액티비티를 찾아보세요. 확인된 방문은 내 여정의 발자취로 남아요.",
    bodyEn: "Choose a region on the Korea atlas, then use the live map to find places and activities. Confirmed visits become part of your journey.",
  },
  {
    icon: BadgeCheck,
