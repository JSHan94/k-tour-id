    ...
    <PhoneFrame>
      ...
      <main className="pb-8">
        ...
        <section className="px-6 pt-6">
          <p className="flex items-center gap-1.5 text-[12px] font-semibold text-success"><BadgeCheck className="h-4 w-4" />{eligible ? (ko ? "내 K-Tour ID로 이용 가능" : "Available with your K-Tour ID") : (ko ? "현재 ID 유형은 혜택 비대상" : "Benefit unavailable for this ID")}</p>
