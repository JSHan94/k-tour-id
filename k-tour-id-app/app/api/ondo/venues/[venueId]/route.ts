import { CANONICAL_VENUE_DETAIL_SOURCE, canonicalVenueDetailById } from "@/lib/ondo/venues/detail-server"
...
export async function GET(_request: Request, context: { params: Promise<{ venueId: string }> }) {
  ...
  const response: CanonicalVenueDetailResponse = { venue, source: CANONICAL_VENUE_DETAIL_SOURCE }
