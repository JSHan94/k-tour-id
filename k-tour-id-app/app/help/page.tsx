...
const FAQS = [
  {
    icon: ShieldCheck,
    titleKo: "내 개인정보는 매장에 어떻게 공유되나요?",
    titleEn: "What personal information does a shop receive?",
    bodyKo: "할인에 필요한 자격 결과만 공유해요. 이름, 여권번호, 생년월일 같은 원문 정보는 매장에 전달하지 않습니다. 제출 전 화면에서 공유 항목을 다시 확인할 수 있어요.",
    bodyEn: "Only the eligibility result needed for the discount is shared. The shop does not receive your name, passport number or date of birth. You can review every item before submitting.",
    href: "/pass",
    ctaKo: "개인정보 안내 보기",
  ...
  },
  {
    ...
    bodyKo: "참여 매장에서 K-Tour ID를 제시하고 매장의 요청을 확인하세요. 자격 확인이 끝나면 사용할 혜택과 최종 결제 금액을 보고 결제할 수 있습니다.",
    bodyEn: "Present your K-Tour ID at a participating shop and review its request. Once eligibility is confirmed, choose the benefit and review the final amount before paying.",
    href: "/present",
    ctaKo: "여행자 할인받기",
