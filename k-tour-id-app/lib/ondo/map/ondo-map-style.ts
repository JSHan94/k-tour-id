 ...
 */
export function ondoMapStyle(locale: MapLocale): StyleSpecification {
  return {
    version: 8,
    ...
    layers: [
      { id: "canvas", type: "background", paint: { "background-color": "#fbfbfa" } },
      {
        id: "park",
        type: "fill",
        source: "openmaptiles",
      ...
      },
      {
        ...
        minzoom: 16,
        paint: { "fill-color": "#f3f3f1", "fill-outline-color": "#e9e9e6", "fill-opacity": 0.58 },
      },
      {
        id: "roads-minor",
        type: "line",
