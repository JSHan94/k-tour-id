import type { DemoClaimKey, DemoJourney, UserType, Voucher } from "@/lib/types"
...
export function demoClaimValue(key: DemoClaimKey, userType: UserType | null, voucher?: Voucher): boolean {
  if (key === "credentialActive" || key === "tripActive" || key === "ageOver19") return true
