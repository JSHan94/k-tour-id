...
export const DEFAULT_CAPSULE: KPassCapsule = {
  ...
  stayPeriod: "Service trip window · 90 days",
...
export const DEFAULT_EVENTS: ChainEvent[] = [
  {
    ...
    evidence: {
      ...
      payloadHash: "0x9a1c3e5f7b2d4a6c8e0f1a3c5e7b9d0f2a4c6e8b0d2f4a6c8e0b2d4f6a8c0e2d",
    },
  },
  {
    id: "evt-2",
    ...
    summary: "KRW travel balance linked to the K-Tour credential holder",
    integrationMode: "simulated",
    evidence: {
      network: "OmniOne Chain adapter",
      payloadHash: "0x4d6f8a0c2e4b6d8f0a2c4e6b8d0f2a4c6e8b0d2f4a6c8e0b2d4f6a8c0e2d4f6a",
    },
  },
]
...
export const DEFAULT_NOTIFICATIONS: AppNotification[] = [
  ...
  { id: 3, type: "security", title: "K-Tour ID verified", message: "Credential status confirmed", time: "1 day ago", read: true, icon: "shield", iconBg: "#ece6da" },
...
export const ACTIVITIES: Activity[] = [
  {
    ...
    geo: { latitude: 37.528, longitude: 126.934 },
    time: "오늘 19:00",
    timeEn: "Today 19:00",
  ...
  },
  {
    ...
    imagePosition: "center",
    geo: { latitude: 37.557, longitude: 126.924 },
    time: "토 15:00",
    timeEn: "Sat 15:00",
    languages: ["한국어", "English"],
    capacity: 8,
  ...
  },
  {
    ...
    geo: { latitude: 37.576, longitude: 126.977 },
    time: "내일 14:00",
  ...
  },
  {
    ...
    imagePosition: "center",
    geo: { latitude: 37.498, longitude: 127.028 },
    time: "일 16:00",
    timeEn: "Sun 16:00",
    languages: ["한국어", "English"],
    capacity: 6,
  ...
  },
  {
    ...
    geo: { latitude: 37.551, longitude: 126.988 },
    time: "금 20:00",
    timeEn: "Fri 20:00",
  ...
  {
    id: "act-busan-market-walk",
    category: "food",
    title: "자갈치 시장 한입 산책",
    titleEn: "Jagalchi Market Bite Walk",
    host: "이지은",
    hostFlag: "🇰🇷",
    hostPhoto: "/portraits/jieun-v2.jpg",
    hostType: "korean",
    trustLevel: "verified",
    place: "부산 자갈치시장 7번 출구",
    placeEn: "Jagalchi Market Exit 7, Busan",
    image: "/editorial-neighborhood-meal.jpg",
    imagePosition: "center",
    ...
    capacity: 6,
    joined: 3,
    participants: ["/portraits/jieun-v2.jpg", "/portraits/emma-v2.jpg", "/portraits/daniel-v2.jpg"],
    costKRW: 22000,
  },
  {
    id: "act-jeju-sunrise",
    category: "tour",
    title: "성산 일출 친구 산책",
    titleEn: "Seongsan Sunrise Friend Walk",
    host: "Emma Clarke",
    hostFlag: "🇬🇧",
    hostPhoto: "/portraits/emma-v2.jpg",
    hostType: "foreigner",
    trustLevel: "verified",
    place: "제주 성산일출봉 매표소 앞",
    placeEn: "Seongsan Ilchulbong ticket office, Jeju",
    image: "/seoul-after-rain-hero.jpg",
    imagePosition: "center 54%",
    geo: { latitude: 33.458, longitude: 126.942 },
    time: "내일 06:10",
    timeEn: "Tomorrow 06:10",
    languages: ["English", "한국어"],
    capacity: 5,
    joined: 2,
    participants: ["/portraits/emma-v2.jpg", "/portraits/nguyen-v2.jpg"],
  },
]
...
export const CONNECT_MESSAGES: ConnectMessage[] = [
  ...
  { id: "m5", fromMe: false, senderName: "김민준", senderPhoto: "/portraits/minjun-v3.jpg", text: "배민으로 같이 주문하고 ‘비용 나누기’로 각자 18,000원씩 내요 👍", textEn: "We'll order together on Baemin and split the cost — ₩18,000 each 👍", time: "오후 5:07", timeEn: "5:07 PM" },
]
