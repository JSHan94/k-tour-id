...
export const MARKETPLACE_ITEMS: MarketplaceItem[] = [
  ...
  {
    id: "gangneung-market-tea-walk",
    category: "experience",
    service: "reservation",
    title: { ko: "강릉 시장 차와 월화거리 산책", en: "Gangneung market tea and Wolhwa walk" },
    description: { ko: "월화거리에서 출발해 오래된 시장의 차와 간식을 맛보며 지역 이야기를 듣는 소규모 산책이에요.", en: "A small-group walk from Wolhwa Street through an old market, with local tea, snacks and neighborhood stories." },
    location: { ko: "강원 강릉 월화거리", en: "Wolhwa Street, Gangneung" },
    geo: { latitude: 37.752, longitude: 128.876 },
    availability: { ko: "내일 10:30 · 5자리", en: "Tomorrow 10:30 · 5 spots" },
    duration: { ko: "약 90분", en: "About 90 min" },
    fulfilment: "booking",
    fulfilmentLabel: { ko: "예약 확정 후 만남 장소 안내", en: "Meeting-point details after confirmation" },
    cancellation: { ko: "이용 24시간 전까지 무료 취소", en: "Free cancellation until 24 hours before" },
    languageLabels: ["한국어", "English"],
    merchant: "Gangneung Local Walks",
    image: "/korean-tea-ceremony.png",
    priceKRW: 29_000,
    rating: 4.8,
    options: [
      { id: "tomorrow-1030", label: { ko: "내일 10:30", en: "Tomorrow 10:30" }, available: true },
      { id: "saturday-1430", label: { ko: "토요일 14:30", en: "Saturday 14:30" }, available: true },
    ],
    eligibleUserTypes: ["foreigner", "long-term", "korean"],
    featuredFor: ["korean", "foreigner"],
    integrationMode: "simulated",
  ...
  {
    id: "jeonju-bibimbap-table",
    category: "experience",
    service: "reservation",
    title: { ko: "전주 한옥마을 비빔밥 한 상", en: "Jeonju hanok bibimbap table" },
    description: { ko: "한옥 부엌에서 제철 재료를 고르고 전주식 비빔밥을 함께 완성하는 식문화 체험이에요.", en: "Choose seasonal ingredients in a hanok kitchen and make a Jeonju-style bibimbap meal together." },
    location: { ko: "전북 전주 한옥마을", en: "Jeonju Hanok Village" },
    geo: { latitude: 35.814, longitude: 127.153 },
    availability: { ko: "오늘 17:30 · 4자리", en: "Today 17:30 · 4 spots" },
    duration: { ko: "약 2시간", en: "About 2 hours" },
    fulfilment: "booking",
    fulfilmentLabel: { ko: "예약 후 모바일 입장 안내", en: "Mobile entry details after booking" },
    cancellation: { ko: "이용 24시간 전까지 무료 취소", en: "Free cancellation until 24 hours before" },
    languageLabels: ["한국어", "English"],
    merchant: "Jeonju Table Lab",
    image: "/korean-bibimbap.png",
    priceKRW: 42_000,
    rating: 4.9,
    options: [
      { id: "today-1730", label: { ko: "오늘 17:30", en: "Today 17:30" }, available: true },
      { id: "tomorrow-1130", label: { ko: "내일 11:30", en: "Tomorrow 11:30" }, available: true },
    ],
    eligibleUserTypes: ["foreigner", "long-term", "korean"],
    featuredFor: ["foreigner", "korean"],
    integrationMode: "simulated",
  },
  {
    id: "gyeongju-night-heritage-walk",
    category: "experience",
    service: "reservation",
    title: { ko: "경주 신라 유산 저녁 산책", en: "Gyeongju Silla heritage evening walk" },
    description: { ko: "황리단길에서 대릉원까지 천천히 걸으며 신라 유산과 오늘의 골목 이야기를 함께 들어요.", en: "Walk slowly from Hwangnidan-gil to Daereungwon and hear how Silla heritage meets today's neighborhood." },
    location: { ko: "경북 경주 황리단길", en: "Hwangnidan-gil, Gyeongju" },
    geo: { latitude: 35.838, longitude: 129.211 },
    availability: { ko: "오늘 19:00 · 6자리", en: "Today 19:00 · 6 spots" },
    duration: { ko: "약 100분", en: "About 100 min" },
    fulfilment: "booking",
    fulfilmentLabel: { ko: "예약 확정 후 집결지 안내", en: "Meeting-point details after confirmation" },
    cancellation: { ko: "이용 12시간 전까지 무료 취소", en: "Free cancellation until 12 hours before" },
    languageLabels: ["한국어", "English", "日本語"],
    merchant: "Gyeongju Story Walk",
    image: "/korean-traditional-event-banner.png",
    priceKRW: 24_000,
    rating: 4.8,
    options: [
      { id: "today-1900", label: { ko: "오늘 19:00", en: "Today 19:00" }, available: true },
      { id: "tomorrow-1900", label: { ko: "내일 19:00", en: "Tomorrow 19:00" }, available: true },
    ],
    eligibleUserTypes: ["foreigner", "long-term", "korean"],
    featuredFor: ["foreigner", "korean"],
    integrationMode: "simulated",
  ...
  {
    id: "busan-jagalchi-breakfast-walk",
    category: "experience",
    service: "reservation",
    title: { ko: "부산 자갈치 아침 식문화 산책", en: "Busan Jagalchi breakfast walk" },
    description: { ko: "자갈치시장의 아침 풍경을 보고 상인 추천 한입 메뉴를 맛보며 원도심까지 이어 걷는 체험이에요.", en: "See Jagalchi Market wake up, taste small vendor picks and continue on foot through the old city center." },
    location: { ko: "부산 자갈치·남포", en: "Jagalchi and Nampo, Busan" },
    geo: { latitude: 35.097, longitude: 129.031 },
    availability: { ko: "내일 09:00 · 5자리", en: "Tomorrow 09:00 · 5 spots" },
    duration: { ko: "약 2시간", en: "About 2 hours" },
    fulfilment: "booking",
    fulfilmentLabel: { ko: "예약 후 시장 집결지 안내", en: "Market meeting point after booking" },
    cancellation: { ko: "이용 24시간 전까지 무료 취소", en: "Free cancellation until 24 hours before" },
    languageLabels: ["한국어", "English"],
    merchant: "Busan Harbor Walks",
    image: "/korean-kimchi-stew.png",
    priceKRW: 36_000,
    rating: 4.8,
    options: [
      { id: "tomorrow-0900", label: { ko: "내일 09:00", en: "Tomorrow 09:00" }, available: true },
      { id: "sunday-0900", label: { ko: "일요일 09:00", en: "Sunday 09:00" }, available: true },
    ],
    eligibleUserTypes: ["foreigner", "long-term", "korean"],
    featuredFor: ["foreigner", "korean"],
    integrationMode: "simulated",
  ...
  {
    id: "jeju-seongsan-village-morning",
    category: "experience",
    service: "reservation",
    title: { ko: "제주 성산 해안마을 아침 산책", en: "Jeju Seongsan coastal village morning" },
    description: { ko: "성산의 해안 마을을 걸으며 바람과 오름, 마을의 생활 이야기를 듣는 느린 아침 산책이에요.", en: "A slow morning walk through a Seongsan coastal village, with stories of island winds, oreum and daily life." },
    location: { ko: "제주 동부 성산", en: "Seongsan, East Jeju" },
    geo: { latitude: 33.458, longitude: 126.942 },
    availability: { ko: "내일 08:30 · 6자리", en: "Tomorrow 08:30 · 6 spots" },
    duration: { ko: "약 90분", en: "About 90 min" },
    fulfilment: "booking",
    fulfilmentLabel: { ko: "예약 확정 후 해안 집결지 안내", en: "Coastal meeting point after confirmation" },
    cancellation: { ko: "이용 24시간 전까지 무료 취소", en: "Free cancellation until 24 hours before" },
    languageLabels: ["한국어", "English"],
    merchant: "Seongsan Village Walk",
    image: "/seoul-after-rain-hero.jpg",
    priceKRW: 28_000,
    rating: 4.9,
    options: [
      { id: "tomorrow-0830", label: { ko: "내일 08:30", en: "Tomorrow 08:30" }, available: true },
      { id: "saturday-0830", label: { ko: "토요일 08:30", en: "Saturday 08:30" }, available: true },
    ],
    eligibleUserTypes: ["foreigner", "long-term", "korean"],
    featuredFor: ["foreigner", "korean"],
    integrationMode: "simulated",
