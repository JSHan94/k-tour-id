...
export const PERSONA_CONFIG: Record<UserType, PersonaConfig> = {
  foreigner: {
    ...
    completionTitle: { ko: "90일 K-Tour 서비스가\n준비됐어요.", en: "Your 90-day K-Tour service\nis ready." },
    ...
    statusDetail: { ko: "D-43", en: "43 days left" },
  ...
  "long-term": {
    ...
    balanceLabel: { ko: "생활 잔액", en: "Living balance" },
  ...
  korean: {
    ...
    balanceLabel: { ko: "여행 잔액", en: "Trip balance" },
...
export const MARKETPLACE_ITEMS: MarketplaceItem[] = [
  ...
  },
  {
    ...
    description: { ko: "출퇴근과 일상 이동을 한 번에 준비하는 장기 체류자용 디지털 교통권 예시예요.", en: "A digital transit-pass concept for everyday commuting and city travel." },
    ...
    fulfilment: "instant",
    fulfilmentLabel: { ko: "결제 후 지갑에 즉시 발급", en: "Issued to Wallet after payment" },
    cancellation: { ko: "개시 전 전액 취소 · 개시 후 잔여일 기준", en: "Full refund before activation; prorated after" },
    languageLabels: ["한국어", "English"],
    merchant: "Seoul Living Mobility · demo concept",
  ...
  },
  {
    ...
    languageLabels: ["한국어"],
    merchant: "Suwon Local Culture Lab · demo concept",
  ...
  },
  {
    ...
    languageLabels: ["한국어", "English"],
    merchant: "Yeonhui Table · demo concept",
  ...
  },
  {
    ...
    languageLabels: ["한국어", "English"],
    merchant: "Euljiro Design Market · demo concept",
  ...
  },
  {
    ...
    languageLabels: ["한국어", "English"],
    merchant: "Insadong Tea Room · demo concept",
...
const PERSONA_VOUCHERS: Record<UserType, Voucher[]> = {
  foreigner: [
    {
      id: "voucher-bukchon-10", title: "Bukchon visitor workshop · 10%", partner: "Bukchon Craft House · demo merchant",
      valueKRW: 5_000, expiresAt: "2026-11-01T23:59:59+09:00", status: "available", eligibilityClaim: "visitorEligibility",
      funding: "municipal-campaign", applicableMerchant: "Bukchon Craft House · demo merchant", applicableService: "reservation",
    ...
    {
      id: "voucher-welcome-10", title: "K-Tour welcome coupon", partner: "K-Tour ID demo network",
      valueKRW: 10_000, expiresAt: "2026-11-01T23:59:59+09:00", status: "available", eligibilityClaim: "couponUnused",
      funding: "partner-funded", applicableMerchant: "Euljiro Design Market · demo concept", applicableService: "shopping",
  ...
  "long-term": [
    {
      id: "voucher-resident-transit", title: "Resident mobility welcome · ₩5,000", partner: "Seoul Living Mobility · demo concept",
      valueKRW: 5_000, expiresAt: "2026-10-31T23:59:59+09:00", status: "available", eligibilityClaim: "couponUnused",
      funding: "municipal-campaign", applicableMerchant: "Seoul Living Mobility · demo concept", applicableService: "transport",
  ...
  korean: [
    {
      id: "voucher-local-culture", title: "Regional culture week · ₩7,000", partner: "Suwon Local Culture Lab · demo concept",
      valueKRW: 7_000, expiresAt: "2026-10-31T23:59:59+09:00", status: "available", eligibilityClaim: "couponUnused",
      funding: "municipal-campaign", applicableMerchant: "Suwon Local Culture Lab · demo concept", applicableService: "reservation",
