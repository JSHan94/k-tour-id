...
const COPY = {
  en: {
    ...
    confirmBody: "This removes saved places, recent views, joined Tables, Local Signals, discovery choices, private notes, Account, Person, 19+, Payment, profile, activity signals, visit stamps, Travel Wallet receipts, After 19 preferences, and Labs state.",
  ...
  ko: {
    ...
    confirmBody: "저장한 장소, 최근 본 장소, 참여한 테이블, 로컬 시그널, 탐색 선택, 개인 메모, 계정·본인·19+·결제 상태, 프로필·활동 신호·방문 스탬프, 여행 지갑 영수증, After 19 설정과 Labs 상태를 삭제합니다.",
  ...
  ja: {
    ...
    confirmBody: "保存した場所、最近見た場所、参加したTable、ローカルシグナル、探索設定、プライベートメモ、アカウント・本人・19歳以上・決済の状態、プロフィール・活動シグナル、訪問スタンプ、旅のウォレットのレシート、After 19設定、Labsの状態を削除します。",
