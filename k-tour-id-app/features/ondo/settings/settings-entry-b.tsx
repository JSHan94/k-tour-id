...
function DeviceClearConfirmation({ locale, onCancel, onConfirm }: {
  ...
  return (
    <div className={styles.confirmLayer} ref={layerRef} role="dialog" aria-modal="true" aria-labelledby="b-clear-title" data-testid="ondo-b-clear-device-confirm" onKeyDown={(event) => {
      ...
      <div className={styles.confirmCard}>
        ...
        <div>
          ...
          <button type="button" onClick={onConfirm}>{locale === "ko" ? "저장 내용 지우기" : "Clear saved content"}</button>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className={styles.screen} data-testid="ondo-b-settings-entry">
      ...
      <section className={styles.settingsSection} aria-labelledby="b-privacy-heading">
        ...
        <button className={styles.clearButton} type="button" onClick={() => setClearOpen(true)} data-testid="ondo-b-clear-device-open">
