...
const COPY = {
  en: {
    ...
    localSignalBoundary: "Save a quick tag and optional photo in this open, device-local flow.",
  ...
  ko: {
    ...
    localSignalBoundary: "이 기기에서 열린 흐름에 짧은 태그와 선택 사진을 저장하세요.",
  ...
  ja: {
    ...
    localSignalBoundary: "この端末で開いている操作に、短いタグと任意の写真を保存します。",
