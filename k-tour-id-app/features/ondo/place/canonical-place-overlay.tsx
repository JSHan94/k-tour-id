...
const COPY = {
  en: {
    ...
    demoOfferBody: "Use your OOKRW Test balance in this app. This offer comes from ONDO, not the official place record or venue.",
    close: "Close place",
  ...
  ko: {
    ...
    demoOfferBody: "이 앱에서 OOKRW Test 잔액을 사용합니다. 이 혜택은 공식 장소 기록이나 매장이 아닌 ONDO에서 제공합니다.",
    close: "장소 닫기",
    back: "장소 요약으로",
