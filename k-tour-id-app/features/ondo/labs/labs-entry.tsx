    ...
    <Sheet label="Labs" onClose={close} showClose={false} size="full">
      <div className={styles.body} data-wallet-state={wallet} data-bridge-state={bridge} data-bridge-phase={phase} data-mint-state={mint} data-testid="labs-overlay">
        ...
        <section className={styles.card} aria-labelledby="labs-signer-title">
          <div className={styles.sectionHeading}><span><WalletCards size={18} /></span><div><h3 id="labs-signer-title">{locale === "ko" ? "Sui zkLogin · 서명 방식 식별자" : "Sui zkLogin signer"}</h3><p>Target network: Sui Testnet · Simulated</p></div></div>
