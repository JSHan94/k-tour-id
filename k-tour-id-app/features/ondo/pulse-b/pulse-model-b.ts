...
const curatedEvidence = (en: string, ko: string): readonly PulseEvidenceB[] => Object.freeze([
  { origin: "curated-walkthrough", label: { en, ko } },
])
...
export function pulseLevelLabel(level: PulseLevelB, locale: "en" | "ko") {
  const labels = {
    peak: { en: "PEAK", ko: "피크" },
    hot: { en: "HOT", ko: "핫" },
    rising: { en: "RISING", ko: "상승" },
    warming: { en: "WARMING", ko: "달아오름" },
    low: { en: "LOW", ko: "여유" },
    limited: { en: "LIMITED", ko: "신호 부족" },
  } as const
