...
const COPY = {
  en: {
    eyebrow: "Tonight in Seoul",
    title: "Pulse Tables",
    intro: "Small plans anchored to a real place, with the details you need before choosing a seat.",
    truth: "Prototype truth · Activity stays in this tab. Nothing is booked, sent to the venue, or charged.",
    official: "Place record",
    officialBoundary: "LOCALDATA confirms the licensed place. The host provides the gathering details.",
    timeLabel: "When",
  ...
  ko: {
    ...
    truth: "프로토타입 안내 · 활동은 이 탭에만 남아요. 예약·장소 전송·결제는 일어나지 않습니다.",
    official: "장소 기록",
    officialBoundary: "LOCALDATA는 인허가 장소를 확인하고, 모임 정보는 호스트가 제공합니다.",
    timeLabel: "시간",
    time: "금요일 · 20:30 KST",
    menuLabel: "음식 계획",
