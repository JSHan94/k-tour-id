...
const COPY = {
  en: {
    ...
    failedBody: "Your Table, place, and join note are unchanged.",
  ...
  ko: {
    ...
    failedBody: "테이블·장소·참여 메모가 그대로 유지됩니다.",
    unsupportedTitle: "19+ 확인을 사용할 수 없어요",
  ...
  ja: {
    ...
    failedBody: "Table、場所、参加メモはそのままです。",
