...
const COPY = {
  en: {
    ...
    sessionDescription: "This signs out of the simulated browser account and clears identity, 19+, Payment KYC, profile, activity, Tables, chat, reports, Labs, and accepted visits. No server account is created or deleted.",
    sessionDescriptionGuest: "This clears identity, 19+, Payment KYC, profile, activity, Tables, chat, reports, Labs, and accepted visits from this browser tab. This preview has no connected server account.",
  ...
  ko: {
    ...
    sessionDescription: "시뮬레이션 브라우저 계정에서 로그아웃하고 본인·19+·결제용 KYC·프로필·활동·모임·대화·신고·Labs·인정된 방문을 지웁니다. 서버 계정을 만들거나 삭제하지 않아요.",
    sessionDescriptionGuest: "본인·19+·결제용 KYC·프로필·활동·모임·대화·신고·Labs·인정된 방문을 이 브라우저 탭에서 지웁니다. 이 미리보기에는 연결된 서버 계정이 없어요.",
