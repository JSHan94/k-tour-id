...
const COPY = {
  en: {
    ...
    accountBody: "You’ll return to the same task after account creation. This does not complete a person check.",
    accountStart: "Create account · Simulated",
    accountSuccess: "Complete account simulation",
    personTitle: "Complete a person check",
    personBody: "This confirms specific identity-related eligibility. It does not guarantee safety, character, or expertise.",
    cx: "Check with Mobile ID",
    cxNote: "Simulates the OmniOne CX route.",
    residence: "Check with Mobile Residence Card",
    residenceNote: "Availability is checked first.",
    ...
    unsupportedBody: "Mobile Residence Card support is being confirmed. You can choose the passport provider route or return to the previous task.",
    ...
    paymentBody: "Payment KYC is separate from your account, person check, and 19+ status.",
  ...
  ko: {
    ...
    accountBody: "계정을 만든 뒤 지금 하던 작업으로 돌아옵니다. 사람 확인은 아직 완료되지 않아요.",
    accountStart: "계정 만들기 · 시뮬레이션",
    accountSuccess: "계정 시뮬레이션 완료",
    personTitle: "사람 확인을 완료해 주세요",
    personBody: "특정 신원 관련 자격만 확인하며, 안전·성품·전문성을 보증하지 않습니다.",
    cx: "모바일 신분증으로 확인",
    cxNote: "OmniOne CX 경로를 시뮬레이션합니다.",
    residence: "모바일 외국인등록증으로 확인",
    residenceNote: "지원 여부를 먼저 확인합니다.",
    passport: "Passport verification provider로 확인",
    passportNote: "실제 업체 계약 전까지 중립 명칭을 사용합니다.",
    selectRoute: "계속할 확인 경로를 선택하세요",
    startCheck: "확인 시작",
    completeCheck: "확인 시뮬레이션 완료",
    unavailable: "미연결 상태 보기",
    unsupportedTitle: "이 확인 경로는 아직 연결되지 않았어요.",
    unsupportedBody: "모바일 외국인등록증 지원을 확인 중입니다. Passport provider 경로를 선택하거나 이전 작업으로 돌아갈 수 있어요.",
    alternate: "Passport provider로 대신 확인",
    ageTitle: "계속하려면 19+ 확인이 필요해요",
    ageBody: "필요한 자격만 표시합니다. 이 시뮬레이션은 외부 provider의 영지식 증명 사용을 주장하지 않습니다.",
    ageStart: "19+ 확인 시뮬레이션 시작",
    ageSuccess: "19+ 확인 · 시뮬레이션",
    paymentTitle: "결제용 KYC를 완료해 주세요",
    paymentBody: "결제용 KYC는 계정·사람 확인·19+ 상태와 분리되어 있습니다.",
...
const GATE_LABELS: Record<Locale, Record<GateKind, string>> = {
  en: { account: "Account", person: "Person", age: "19+", payment_kyc: "Payment KYC" },
  ko: { account: "계정", person: "사람 확인", age: "19+", payment_kyc: "결제용 KYC" },
}
