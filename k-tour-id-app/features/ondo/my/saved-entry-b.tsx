...
const COPY = {
  en: {
    ...
    title: "My Korea",
    boundary: "Saved places, recent views, joined Table previews, and Local Signals stay in this browser. They are not visits, reservations, or synced activity.",
    ...
    localPreview: "On-device reference · no reservation",
  ...
  ko: {
    eyebrow: "이 기기",
    title: "내 한국",
    boundary: "저장한 장소, 최근 조회, 참여한 테이블 미리보기와 로컬 시그널은 이 브라우저에만 남습니다. 방문·예약·동기화된 활동 기록이 아닙니다.",
    savedTitle: "저장한 장소",
