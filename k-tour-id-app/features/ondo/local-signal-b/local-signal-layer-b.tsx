...
const COPY = {
  en: {
    ...
    boundaryBody: "Posting saves only a coarse marker for this place on this device. Nothing is uploaded or sent to the place.",
    person: "Continue to Person walkthrough",
    retry: "Retry Person walkthrough",
    post: "Post on this device",
    posted: "Local Signal posted on this device.",
    ...
    alreadyPosted: "A Local Signal marker for this place already exists on this device. Posting again keeps one coarse marker.",
  },
  ko: {
    close: "로컬 시그널 닫기",
    ...
    boundary: "기기 내 로컬 기여",
    boundaryBody: "게시하면 이 장소의 간단한 표시만 이 기기에 저장됩니다. 업로드하거나 장소에 전송하지 않아요.",
    person: "본인 둘러보기로 계속",
    retry: "본인 둘러보기 다시 시도",
    post: "이 기기에 게시",
    posted: "이 기기에 로컬 시그널을 게시했어요.",
    ...
    alreadyPosted: "이 장소의 로컬 시그널 표시가 이미 이 기기에 있습니다. 다시 게시해도 간단한 표시 하나만 유지됩니다.",
  },
} as const
