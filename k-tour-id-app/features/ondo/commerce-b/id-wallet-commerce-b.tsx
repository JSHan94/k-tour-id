...
const COPY = {
  ...
  ko: {
    ...
    noActivityBody: "K-Tour ID 식사 오퍼의 잔액 변화가 여기에 표시됩니다.",
    paidActivity: "잔액 사용",
  ...
  ja: {
    ...
    noActivityBody: "K-Tour IDの食事オファーによる残高の変化がここに表示されます。",
    paidActivity: "残高を使用",
...
const OFFER_COPY = {
  en: {
    eyebrow: "K-Tour ID MEAL BENEFIT",
