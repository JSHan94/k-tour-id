...
const COPY = {
  en: {
    ...
    demo: "DEMO APP · NOT CONNECTED", boundary: "This screen stays inside ONDO. No ID app opens, no QR is generated, and nothing is sent to Mobile ID or OmniOne CX.",
    ...
    return: "Return to ONDO", returnNote: "Review the response before saving a sample pass.",
    ...
    approved: "Sample approval is ready", approvedBody: "Return this prepared response to ONDO. No identity was verified and no pass has been saved.",
  ...
  ko: {
    ...
    demo: "데모 앱 · 실제 연결 없음", boundary: "ONDO 안의 예시 화면이에요. 신분증 앱을 열거나 QR을 만들지 않으며, 모바일 신분증·OmniOne CX에 전송하지 않아요.",
    route: "신분증 연결 단계", consent: "동의 내용 확인", consentNote: "선택한 확인 방법과 여행은 유지돼요.",
    check: "데모 앱에서 승인", checkNote: "준비된 승인 또는 거절 응답을 선택해요.",
    return: "ONDO로 돌아가기", returnNote: "응답을 확인한 뒤 샘플 패스를 보관해요.",
    ...
    approved: "샘플 승인 응답이 준비됐어요", approvedBody: "준비된 응답과 함께 ONDO로 돌아가요. 실제 신원 확인이나 패스 저장은 아직 없어요.",
  ...
  ja: {
    ...
    demo: "デモアプリ・実際の接続なし", boundary: "ONDO内のサンプル画面です。IDアプリは開かず、QRも生成せず、モバイルIDやOmniOne CXへの送信もありません。",
    route: "ID連携の手順", consent: "同意内容を確認", consentNote: "選んだ確認方法と旅行は維持されます。",
    check: "デモアプリで承認", checkNote: "用意された承認または拒否を選びます。",
    return: "ONDOに戻る", returnNote: "応答を確認してからサンプルパスを保存します。",
    ...
    approved: "サンプル承認の準備ができました", approvedBody: "用意された応答でONDOに戻ります。実際の本人確認やパスの保存は行われていません。",
