...
const COPY = {
  en: {
    ...
    one: "One",
    several: "Several",
    historyBoundary: "Local activity preview. It does not rate character, safety or expertise.",
  ...
  ko: {
    ...
    one: "1회",
    several: "여러 번",
    historyBoundary: "로컬 활동 미리보기이며 성품·안전·전문성을 평가하지 않습니다.",
    stampTitle: "여행 스탬프",
  ...
  ja: {
    ...
    one: "1件",
    several: "複数",
    historyBoundary: "ローカル活動のプレビューです。人柄、安全性、専門性を評価しません。",
    stampTitle: "旅のスタンプ",
