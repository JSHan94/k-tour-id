...
const COPY = {
  en: {
    ...
    presentationEvidence: "K-Tour travel eligibility · yes/no only", presentationRetention: "One request · nonce and expiry semantics · no VP stored",
    presentationPredicate: "K-Tour travel eligibility · yes/no only", presentationPredicateRetention: "One request · no VP stored",
    credentialReadyEyebrow: "SIMULATED READY · THIS TAB", presentationRequestEyebrow: "OpenDID · PRESENTATION REQUEST",
    presentationResultApproved: "SIMULATED · APPROVED ONCE", unchanged: "unchanged",
  ...
  ko: {
    ...
    presentationEvidence: "K-Tour 여행 자격 · 예/아니오만", presentationRetention: "한 번의 요청 · nonce와 만료 의미 적용 · VP 저장 안 함",
    presentationPredicate: "K-Tour 여행 자격 · 예/아니오만", presentationPredicateRetention: "한 번의 요청 · VP 저장 안 함",
    credentialReadyEyebrow: "시뮬레이션 준비 완료 · 이 탭", presentationRequestEyebrow: "OpenDID · 자격증명 제시 요청",
    presentationResultApproved: "시뮬레이션 · 한 번 승인됨", unchanged: "상태 변경 없음",
  ...
  ja: {
    ...
    presentationEvidence: "K-Tour旅行資格 · 可否のみ", presentationRetention: "一回の依頼 · nonceと有効期限を適用 · VPは保存しない",
    presentationPredicate: "K-Tour旅行資格 · 可否のみ", presentationPredicateRetention: "一回の依頼 · VPは保存しない",
    credentialReadyEyebrow: "シミュレーション準備完了 · このタブのみ", presentationRequestEyebrow: "OpenDID · 資格情報の提示依頼",
    presentationResultApproved: "シミュレーション · 一回のみ承認", unchanged: "状態変更なし",
