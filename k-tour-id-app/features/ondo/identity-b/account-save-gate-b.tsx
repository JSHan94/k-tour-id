...
const COPY = {
  en: {
    header: "Account",
    trust: "Simulated · this tab",
    title: "Create an account to save this place",
    reason: "Explore stays open to guests. A simulated Account is needed only when you save this place on your device.",
    ...
    contextBody: "This exact official place stays open. There is no note draft in this save action.",
    start: "Create account · Simulated",
    reviewTitle: "Save this place after Account?",
    reviewBody: "Completing the local Account simulation returns here and saves only this official place on this device.",
    complete: "Complete account simulation",
  ...
  ko: {
    ...
    reason: "게스트도 계속 둘러볼 수 있어요. 이 장소를 기기에 저장할 때만 시뮬레이션 계정이 필요합니다.",
    boundary: "이 절차가 하는 일",
    predicate: "연결된 계정 제공기관이나 생성되는 자격증명은 없고, ONDO나 장소로 전송되는 정보도 없습니다. 계정 상태는 이 탭에만 유지됩니다. 본인·19+·결제 확인은 별개이며 완료되지 않습니다.",
    context: "계정 후 돌아올 곳",
    contextBody: "지금 연 공식 장소를 그대로 유지합니다. 이 저장 작업에는 메모 초안이 없습니다.",
    start: "계정 만들기 · 시뮬레이션",
    reviewTitle: "계정을 만든 뒤 저장할까요?",
    reviewBody: "로컬 계정 시뮬레이션을 마치면 이 장소로 돌아와 이 공식 장소만 기기에 저장합니다.",
    complete: "계정 시뮬레이션 완료",
    fail: "실패 상태 보기",
  ...
  ja: {
    ...
    reason: "ゲストのまま探し続けられます。この場所を端末に保存するときだけ、シミュレーション用アカウントが必要です。",
    boundary: "この手続きで行うこと",
    predicate: "アカウント提供事業者への接続や資格情報の作成はなく、ONDOや場所にも何も送信しません。アカウント状態はこのタブだけに保持されます。本人、19歳以上、決済の確認は別で、完了しません。",
    context: "アカウント後の戻り先",
    contextBody: "今開いている同じ公式の場所に戻ります。この保存操作にメモの下書きはありません。",
    start: "アカウントを作成 · シミュレーション",
    reviewTitle: "アカウント作成後に保存しますか？",
    reviewBody: "ローカルのアカウント・シミュレーションが完了すると、ここに戻り、この公式の場所だけを端末に保存します。",
    complete: "アカウント・シミュレーションを完了",
    fail: "失敗状態を表示",
