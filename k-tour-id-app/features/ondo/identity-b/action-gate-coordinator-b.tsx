...
const COPY = {
  en: {
    ...
    checkoutPaymentBody: "Confirm payment readiness, then return to your order. No charge is made on this screen.",
    checkoutPaymentAction: "Confirm and return",
  ...
  ko: {
    ...
    checkoutPaymentBody: "결제 준비 상태를 확인한 뒤 이 결제로 돌아갑니다. 이 화면에서는 금액이 청구되지 않아요.",
    checkoutPaymentAction: "확인하고 돌아가기",
  ...
  ja: {
    ...
    checkoutPaymentBody: "決済準備を確認して、このお支払い画面へ戻ります。この画面では請求されません。",
    checkoutPaymentAction: "確認して戻る",
