...
The ONDO mark is an open atlas contour: a calm travel brand object, not a badge or status symbol.

## Sizes

- Use the dedicated `ondo-mark-micro-16.svg`, `-20.svg`, or `-24.svg` at 16–24 px. Their single contour is tuned for those exact sizes.
...
The primary is near-black `#191817`; inverse is warm white `#F8F7F4`. Do not recolor the mark to a success, warning, Pulse-temperature, identity, or payment color. Never add gradients, shadows, fills, animation, or a destination dot.
