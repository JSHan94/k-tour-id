...
- Square 1:1, head-and-shoulders framing with room for circular avatar crops.
- Warm natural daylight, softly blurred contemporary Seoul context.
- Premium commercial lifestyle photography with natural skin texture and restrained color.
- Exactly one fictional adult; no flags, text, logos, watermarks, costumes, stereotypes, celebrity likenesses, or beauty-filter skin.

## Assets and character prompts
...
| `amara-v2.jpg` | Black American woman Amara Lewis, late 20s, K-pop and exhibition traveler, warm plum and sand smart-casual clothing, gallery-district setting. |
| `emma-v2.jpg` | British woman Emma Clarke, late 20s, independent traveler, forest-green and cream clothing, Seoul riverside or café setting. |

## Product-use rule

Portraits provide a coherent fictional cast and cultural context; they must never be treated as proof of nationality, ethnicity, or eligibility. Those claims are carried only by the explicit mock identity and credential fields.
