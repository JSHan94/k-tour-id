# ONDO Generated Media Registry

These assets are ONDO-owned synthetic editorial media. They are not documentary
evidence, user identity records, provider imagery, official place imagery or
proof that a depicted event occurred.
...
- Any future replacement receives a new filename and registry row so sealed
  visual evidence never silently changes.
