...
test("B-JEJU-EDITORIAL-004 internal editorial detail preserves the reduced truth-safe action set", () => {
  ...
  expect(detail).toContain('data-testid="ondo-b-editorial-place-hero"')
  expect(detail).toContain("heroMedia.alt[locale]")
  expect(detail).toContain("heroMedia.credit[locale]")
