...
const KEY_COPY_BY_CASE_ID: Readonly<Record<string, string>> = {
  "CR-PX-001-ONBOARDING-VALUE-EN": "Find a meal that fits your Korea—grounded in public records.",
  ...
  "CR-PX-004-ONBOARDING-VALUE-KO": "나에게 맞는 한국의 한 끼를, 공공 기록에서 찾아보세요.",
  "CR-PX-005-ONBOARDING-INTENT-KO": "어떤 목적으로 ONDO를 찾았나요?",
  "CR-PX-006-ONBOARDING-PREFERENCES-KO": "어떤 음식과 식이 조건을 찾고 있나요?",
  "CR-PX-007-ONBOARDING-VALUE-JA": "韓国で自分に合う一食を、公的な記録から探そう。",
  ...
  "CR-PX-015-SEOUL-LIST-PULSE": "official records",
  ...
  "CR-PX-027-OPENDID-HOLDER-KO": "데모 holder에 전달",
  "CR-PX-028-TABLE-JOINED-KO": "참여했어요",
  "CR-PX-029-MY-KOREA-TABLE-LINKAGE-KO": "식사 계획",
  "CR-PX-030-LABS-BOUNDARY-JA": "技術的な仮説を体験する実験エリアです。",
  "CR-PX-031-LABS-READY-JA": "Sui zkLogin · 署名方式",
  "CR-PX-032-SEOUL-LIST-PULSE-JA": "公式記録",
