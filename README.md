...
**[K-Tour ID app](https://ktour-id.vercel.app)** · **[main](https://github.com/woogieboogie-jl/k-tour-id/tree/main)** · **[Harvey handoff](https://github.com/woogieboogie-jl/k-tour-id/tree/handoff/harvey-20260914)**. **New Korean share artwork + neighborhood-guide mock: release verification in progress.** Follow the [new release record](./docs/KTOUR_EXPERIENCE_RELEASE_2026-09-15.md) for its actual source, checks and deployment status; this pointer does not claim that the new code is already in production or on the handoff branch. The last verified UX app-code baseline `505e475` and subsequent documentation/test-only updates remain separate evidence in the [previous UX release](./docs/ux-refinement/2026-09-15/RELEASE.md) and [production handoff record](./docs/KTOUR_PRODUCTION_HANDOFF_2026-09-15.md). Provider integrations remain incomplete.
...
The approved [nonfinancial experience mock](./docs/EXPERIENCE_MOCK_HANDOFF_2026-09-15.md) maps Roba → current Person check/scoped presentation → explicit one-action approval → digital guide → same place to Harvey's real integrations. It adds no real CX/OpenDID/AI/Sui/OmniOne calls, merchant voucher or financial/visit entitlement. Its rollout is tracked in the new release record, not inferred from the earlier production checks.
