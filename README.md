...
**[K-Tour ID app](https://ktour-id.vercel.app)** · **[main](https://github.com/woogieboogie-jl/k-tour-id/tree/main)** · **[Harvey handoff](https://github.com/woogieboogie-jl/k-tour-id/tree/handoff/harvey-20260914)**. **September 16 UX polish is deployed from app source `8fcbeb1`: place actions, funding context, scoped pass preparation and a licensed Jeju food photo.** See the [latest review and release record](./docs/ux-refinement/2026-09-15/round-20260916.md) for checks and held decisions, and the [production handoff](./docs/KTOUR_PRODUCTION_HANDOFF_2026-09-15.md) for deployment and synchronized branches. Later documentation-only commits preserve this app source. The [initial experience release](./docs/KTOUR_EXPERIENCE_RELEASE_2026-09-15.md) and [previous UX release](./docs/ux-refinement/2026-09-15/RELEASE.md) remain historical evidence. Provider integrations remain incomplete.
