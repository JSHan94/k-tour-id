...
**[K-Tour ID app](https://ktour-id.vercel.app)** · **[main](https://github.com/woogieboogie-jl/k-tour-id/tree/main)** · **[Harvey handoff](https://github.com/woogieboogie-jl/k-tour-id/tree/handoff/harvey-20260914)**. **Korean share artwork + neighborhood-guide mock are deployed from app source `5712aed`.** See the [new release record](./docs/KTOUR_EXPERIENCE_RELEASE_2026-09-15.md) for scoped checks and the [production handoff](./docs/KTOUR_PRODUCTION_HANDOFF_2026-09-15.md) for the verified deployment and synchronized branches. Later documentation/test-only commits preserve this app source; the [previous UX release](./docs/ux-refinement/2026-09-15/RELEASE.md) remains historical evidence. Provider integrations remain incomplete.
