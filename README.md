...
**[K-Tour ID app](https://ktour-id.vercel.app)** · **[main](https://github.com/woogieboogie-jl/k-tour-id/tree/main)** · **[Harvey handoff](https://github.com/woogieboogie-jl/k-tour-id/tree/handoff/harvey-20260914)**. **Production Ready; app-code baseline: `505e475`.** See the [UX release](./docs/ux-refinement/2026-09-15/RELEASE.md) and [production handoff record](./docs/KTOUR_PRODUCTION_HANDOFF_2026-09-15.md) for verified flows, branch synchronization and subsequent documentation/test-only updates. This is a pure mock release, not completed provider integration.
