...
**[K-Tour ID app](https://ktour-id.vercel.app)** · **[main](https://github.com/woogieboogie-jl/k-tour-id/tree/main)** · **[Harvey handoff](https://github.com/woogieboogie-jl/k-tour-id/tree/handoff/harvey-20260914)**. **Production Ready; app-code and branch-synchronization verification baseline: `4cb1964`.** See the [current production handoff record](./docs/KTOUR_PRODUCTION_HANDOFF_2026-09-15.md) for the deployment, checks and subsequent documentation-only updates. This is a pure mock release, not completed provider integration.
